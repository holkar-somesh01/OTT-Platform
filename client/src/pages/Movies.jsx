...
const Movies = () => {
    const { data: movies = [], isLoading } = useGetMoviesQuery('movie');
    ...
    return (
        <div className="bg-primary min-h-screen text-primary-text pb-10">
            ...
            <div className="-mt-32 relative z-10 space-y-8 pl-4 sm:pl-12">
                <Row title="Trending Movies" movies={trending} isLargeRow onMovieClick={setPlayingMovie} />
                <Row title="Top Rated Movies" movies={topRated} onMovieClick={setPlayingMovie} />
